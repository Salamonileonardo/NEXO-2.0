        ...
        <div className="pagina-celular">
          ...
          <nav className="menu-flutuante">
            <a href="#" className="menu-item ativo">
              <svg color="#00e5ff" width="24" height="24" viewBox="0 0 24 24">
            ...
            <a href="#" className="menu-item" onClick={acessarCalendario}>
              <svg width="24" height="24" viewBox="0 0 24 24">
                <path d="M19 4h-1V2h--1.1 0-2 .9-  1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H5V8h14v10z" />
              </svg>
              Calendário
            </a>
          </nav>
